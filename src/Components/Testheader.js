...
class Testheader extends Component {
    ...
    constructor() {
      ...
      toggleModal_feedback = () => {
        this.setState({
          isOpen_feedback: !this.state.isOpen_feedback
        });
      }
      toggleModal_help = () => {
        this.setState({
    ...
    render() {
       ...
       return (
        ...
        <div className="header_home">
            ...
            <button className="headbutton" onClick={this.showview}>
            ...
            <button className="headbutton" onClick={this.showplus}>
            <img src= {plus} alt="error" className="icons"/>
            </button>
            {
          this.state.showview
            ? (
          ...
          this.state.showplus
            ? (
              <div className="menu3" ref={(element) => { this.dropdownMenu = element;}}> 
                ...
                <button onClick={this.toggleModal_attendance}  className="inneritems"> attendance list </button><br/>
                <button  onClick={this.toggleModal_timetable} className="inneritems"> time table </button>
                <button  onClick={this.toggleModal_feedback} className="inneritems"> feedback </button>
              </div>
            )
            : (
              null
        ...
        <Modal9 show={this.state.isOpen_feedback}
          onClose={this.toggleModal_feedback}>
          Here's some content for the modal
        </Modal9>
