...
class Modal4 extends React.Component {
  ...
  okclick(){
    ...
    if(document.getElementById('area').value ===""||document.getElementById('name').value===""){
    ...
    axios.post('http://192.168.43.208/6000', {
          ...
          "emails":document.getElementById('area').value
  ...
  const feedback={
    ...
    return (
      <div className="backdrop" style={backdropStyle}>
        ...
        <h4 style={textstyle}>Create email group</h4><hr/><br/>
        <input type="text" name="grpname" placeholder="group name" id="name" className="text_box_sign"/>
        <textarea id="area" style={areastyle}/>
